...
public:
	...
	bool is_skel_virtual;
	bool is_skel_branch;
	
	/* for upsampling */
	//bool bIsAbandonByThreshold;
...
//
//typedef vcg::Face<CUsedTypes, vcg::face::VertexRef> CFace ;
//typedef vcg::tri::TriMesh< std::vector<CVertex>, std::vector<CFace> > CMesh ;
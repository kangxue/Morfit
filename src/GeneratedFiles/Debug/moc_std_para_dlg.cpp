...
struct qt_meta_stringdata_StdParaDlg_t {
    QByteArrayData data[3];
    char stringdata[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_StdParaDlg_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_StdParaDlg_t qt_meta_stringdata_StdParaDlg = {
    {
QT_MOC_LITERAL(0, 0, 10),
QT_MOC_LITERAL(1, 11, 10),
QT_MOC_LITERAL(2, 22, 0)
    },
    "StdParaDlg\0closeClick\0\0"
};
...
const QMetaObject StdParaDlg::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_StdParaDlg.data,
      qt_meta_data_StdParaDlg,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StdParaDlg.stringdata))

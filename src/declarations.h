...
#define _load_x 0  // will not use this 
#define  _show_correspondence 0
#define  _use_360dis 0
#define  _use_openmp_
#define  Warm0_Morph1_Fit2 2
#define  _Fitting_Only 0

#define  _Solver_TNUM_ 64

#ifdef _DEBUG
#define  After_solve_DEBUG
#endif

#define _no_warm_start
//
//#define  _useShader_
//#define SHADER_NAME "glass"

...
public:
	...
	void draw(DrawType type, CMesh* mesh,  bool isSamples, std::vector<bool> & );
...
public:
	void drawSelectedPoint(CMesh* samples, vector<bool>& sampleIsSelected, bool bShow_as_dot) ;

	void  drawDisk(  CMesh* _mesh ) ;
	void  drawPolygonOnScreen(  CMesh* _mesh, double length, int edgeNum ) ;
	void  drawSampleDiskOnScreen(  CMesh* _mesh, std::vector<bool> &sampleIsSelected, std::vector<bool> &sampleIsBoundary, std::vector<int> &sampleClusterId ) ;
	void DrawHeightMap(  CMesh* _mesh, std::vector<bool> &sampleIsSelected  ) ;
	void drawSamplesAsDot(CMesh* _mesh, std::vector<bool> &sampleIsSelected,std::vector<bool> &sampleIsBoundary, std::vector<int> &sampleClusterId  ) ;

	void drawSkeleton(skeleton_mul &branches, GLColor gl_color ) ;

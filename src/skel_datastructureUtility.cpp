...
skeleton_mul::skeleton_mul( std::vector<std::vector<Point3f>> & brchPts, bool dsample = true) {
	iditifier = clock(); 
...
skeleton_mul::skeleton_mul( completionSolver solver ) {
...
void skeleton_mul::convertVerticesListToGraph(){
...
void skeleton_mul::convertGraphToVerticeList(){
...
void skeleton_mul::convertVeticesListToBranchPoints() {
...
void skeleton_mul::convertBranchPointsToVeticesList( double disToMerge ) {
...
void skeleton_mul::getJoints( std::vector<Point3f> &joints, std::vector<std::vector<int>> &ajBrchId ){
...
void skeleton_mul::getTips( std::vector<int2> &endpoints) {

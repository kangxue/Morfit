...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GLArea_t, stringdata) + ofs \
...
void GLArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->needUpdateStatus(); break;
        default: ;
        }
        ...
        {
            typedef void (GLArea::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLArea::needUpdateStatus)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject GLArea::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_GLArea.data,
      qt_meta_data_GLArea,  qt_static_metacall, 0, 0}
};
